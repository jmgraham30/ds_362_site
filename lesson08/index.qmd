...
#| warning: false
#| label: fig-smc
#| fig-cap: Soft margin classifier. (Left) Zero budget for overlap (i.e., the HMC). (Right) Maximumn allowable overlap. The solid black points represent the support vectors that define the margin boundaries.
#| fig-asp: 0.5
#| fig-width: 8
#| fig-out.width: 100%
