...
1) State in general terms what we mean by **data mining** and **machine learning**, also known as **statistical learning**.
...
**Exercise:** Carefully examine the code used to make @fig-egg_report. What does each line of the code do? 
