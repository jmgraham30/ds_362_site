...
\text{specificity or false positive rate} &= \frac{\text{false positive}}{\text{false positive} + \text{true negative}}
\end{align*}
$$

Then, in our example with the 50% threshold value, the sensitivity is `r 100 / (100 + 233)` and the specificity is `r  42 / (42 + 9609)`. 
