...
- [View intro to reinforcement learning video by David Silver on YouTube](https://youtu.be/2pWv7GOvuf0?si=SiwX8SRl15nGsOu-).

```{r}
#| echo: false

vembedr::embed_youtube(id="2pWv7GOvuf0?si=SiwX8SRl15nGsOu-",height=450) %>%
  vembedr::use_align("center")
